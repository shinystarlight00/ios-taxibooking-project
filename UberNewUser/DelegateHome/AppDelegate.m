...
-(void)showLoadingWithTitle:(NSString *)title
{
    ...
    if (viewLoading==nil)
    {
        ...
        viewLoading.backgroundColor = [UIColor clearColor];//[UIColor whiteColor];
        
        UIImageView *imgs=[[UIImageView alloc] initWithFrame:self.window.bounds];

        imgs.image=[UIImage imageNamed:@"bg_loding"];
        //[UIImage imageNamed:[NSString stringWithFormat:@"%@", bg_loding]];
        imgs.alpha=0.90;
        
        CGRect screenRect = [[UIScreen mainScreen] bounds];

        
        UIImageView *img=[[UIImageView alloc]initWithFrame:CGRectMake((screenRect.size.width/2-75),(screenRect.size.height/2-75),150,150)];
        img.backgroundColor=[UIColor clearColor];
        
        img.animationImages=[NSArray arrayWithObjects:[UIImage imageNamed:@"loading_1.png"],[UIImage imageNamed:@"loading_2.png"],[UIImage imageNamed:@"loading_3.png"],[UIImage imageNamed:@"loading_2.png"],nil];
        ...
        UITextView *txt=[[UITextView alloc]initWithFrame:CGRectMake((screenRect.size.width/4), (screenRect.size.width/2+300), 250, 60)];
        
        txt.textAlignment=NSTextAlignmentCenter;
        txt.backgroundColor=[UIColor clearColor];
        txt.text=[title lowercaseString];
